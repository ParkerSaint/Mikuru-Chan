exports.run = (client, message, args) => {
    ...
    if (args.join(" ").toLowerCase() === "are you") {
        ...
        let temp = ["I'm good, thanks~ （⌒▽⌒ゞ", "I'm doing pretty well today.", "Daijoubu~", "I'm feeling a bit better than usual. ໒( ͡ᵔ ▾ ͡ᵔ )७", "I'm good, how are you? （‐＾▽＾‐）", "I'm good, I guess. (*´-｀*)", "I'm feeling under the weather.", "I'm really angry right now. ( ╬◣ 益◢)", "I'm not fine at all. 。・°°・(＞_＜)・°°・。" ];
        message.channel.startTyping();
        setTimeout(() => {
